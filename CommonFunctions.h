...
{
public:
	static int decompressGzip(const uint8 *pData, size_t dataLen, ByteBuffer &rBuffOut, int zlibBufferSize = 128*1024);
	static int compressGzip(int compressionLevel, const uint8 *pData, size_t dataLen, ByteBuffer &rBuffOut, int zlibBufferSize = 128*1024);
